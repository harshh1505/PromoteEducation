        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-12">
            ...
            <h1 className="text-5xl md:text-6xl font-black text-slate-900 leading-[1.05] tracking-tight mb-8">
              How to Write the XAT Essay<br /><span className="text-slate-400">Structure, Topics & Examples</span>
            </h1>
          ...
          <article className="prose prose-slate max-w-none">
            <div className="bg-amber-50 border border-amber-100 rounded-3xl p-8 mb-12">
              ...
              <p className="text-slate-700 text-[15px] leading-relaxed mb-0">XAT's Essay Writing component (required by XLRI and select institutes) tests your ability to construct a coherent, well-argued essay in 20 minutes. Learn the winning structure, common topic themes, and sample essays.</p>
            </div>

            <h2 className="text-3xl font-black text-slate-900 mt-12 mb-6">Essay Structure That Works</h2>
            <div className="space-y-4 mb-8">{[{t:"Introduction (60 words)",d:"Open with a provocative statement or a striking statistic. Define the key terms of the topic. End with your thesis — your central argument."},
{t:"Body Paragraph 1 (80 words)",d:"Your strongest argument supporting your thesis. Use a real-world example (global or Indian business context preferred by XLRI)."},
{t:"Body Paragraph 2 (80 words)",d:"A counter-argument, followed by your rebuttal. This shows intellectual maturity — XLRI rewards nuanced thinking."},
{t:"Conclusion (40 words)",d:"Restate your thesis in new words. End with a forward-looking statement or a call to action."},
].map((i,idx)=>(<div key={idx} className="flex items-start gap-4 p-6 rounded-2xl border border-slate-100 bg-white"><CheckCircle2 size={20} className="text-amber-500 shrink-0 mt-0.5" /><div><div className="text-sm font-black text-slate-900 mb-1">{i.t}</div><p className="text-[14px] text-slate-500 mb-0">{i.d}</p></div></div>))}</div>

            <h2 className="text-3xl font-black text-slate-900 mt-12 mb-6">Common XAT Essay Topics</h2>
            <p className="text-slate-600 leading-relaxed mb-4">XAT essay topics are typically abstract and philosophical: examples include <em>"Poverty is a state of mind"</em>, <em>"Ethical businesses do not exist"</em>, and <em>"The most critical challenge for business leaders today."</em> Practice writing on at least 30 such prompts before the exam.</p>
