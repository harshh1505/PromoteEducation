        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              <span className="px-3 py-1 bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest rounded-md">Programme</span>
            ...
            <h1 className="text-5xl md:text-6xl font-black text-slate-900 leading-[1.05] tracking-tight mb-8">
              XLRI HRM vs BM<br /><span className="text-slate-400">Which Programme Should You Choose?</span>
            </h1>
          ...
          <article className="prose prose-slate max-w-none">
            <div className="bg-amber-50 border border-amber-100 rounded-3xl p-8 mb-12">
              ...
              <p className="text-slate-700 text-[15px] leading-relaxed mb-0">A detailed comparison of XLRI's flagship MBA programmes — Human Resource Management (HRM) and Business Management (BM). Covers curriculum, placements, XAT cutoffs, and career trajectories.</p>
            </div>

            <h2 className="text-3xl font-black text-slate-900 mt-12 mb-6">Programme Comparison</h2>
            <div className="overflow-x-auto rounded-2xl border border-slate-100 mb-8"><table className="w-full text-sm"><thead><tr className="bg-slate-900 text-white"><th className="p-4 text-left font-black">Parameter</th><th className="p-4 text-center font-black">HRM</th><th className="p-4 text-center font-black">BM</th></tr></thead><tbody className="divide-y divide-slate-50">{[["Duration","2 years","2 years"],["XAT Cutoff (~)","94-95 percentile","95-96 percentile"],["Average CTC","₹28+ LPA","₹34+ LPA"],["Top Recruiters","Deloitte, Unilever, Amazon (HR)","Goldman Sachs, McKinsey, Google"],["Focus Area","People & Culture","Strategy & Finance"],].map(([p,h,b])=>(<tr key={p} className="hover:bg-slate-50"><td className="p-4 font-bold text-slate-700">{p}</td><td className="p-4 text-center text-amber-600 font-bold">{h}</td><td className="p-4 text-center text-slate-500">{b}</td></tr>))}</tbody></table></div>

            <h2 className="text-3xl font-black text-slate-900 mt-12 mb-6">Which to Choose?</h2>
            <p className="text-slate-600 leading-relaxed mb-4">Choose <strong>HRM</strong> if you are passionate about organisational behaviour, talent management, and people strategy. Choose <strong>BM</strong> if your interest lies in consulting, investment banking, or general management. Both programmes carry XLRI's global reputation and have outstanding placement records.</p>
