        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <header className="mb-12">
            ...
            <h1 className="text-5xl md:text-6xl font-black text-slate-900 leading-[1.05] tracking-tight mb-8">
              XLRI Jamshedpur<br /><span className="text-slate-400">Selection Process & GD-PI</span>
            </h1>
          ...
          <article className="prose prose-slate max-w-none">
            <div className="bg-amber-50 border border-amber-100 rounded-3xl p-8 mb-12">
              ...
              <p className="text-slate-700 text-[15px] leading-relaxed mb-0">Step-by-step guide to the XLRI selection process after XAT — shortlist criteria, Group Discussion format, Personal Interview structure, and final merit list preparation for HRM and BM programmes.</p>
            </div>

            <h2 className="text-3xl font-black text-slate-900 mt-12 mb-6">Shortlist Criteria</h2>
            <div className="space-y-4 mb-8">{[{t:"XAT Percentile Threshold",d:"XLRI typically shortlists candidates with 95+ percentile overall for BM and 94+ for HRM. Sectional cutoffs also apply — especially in VARC and DM."},
{t:"Work Experience",d:"XLRI values work experience significantly. Candidates with 1-3 years of relevant professional experience are preferred for both HRM and BM programmes."},
{t:"Academic Performance",d:"10th and 12th scores matter. A consistent academic track record strengthens your profile, though XLRI does not have a strict cutoff here."},
            ...
            <h2 className="text-3xl font-black text-slate-900 mt-12 mb-6">GD-PI Process</h2>
            <p className="text-slate-600 leading-relaxed mb-4">The XLRI GD-PI is conducted in February-March. The Group Discussion is typically a case study or a current affairs debate (10-12 candidates, 15-20 minutes). The Personal Interview lasts 20-30 minutes and tests leadership potential, domain knowledge, and career clarity.</p>
