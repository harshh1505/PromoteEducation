...
const CATEGORIES = [
  { id: 'all', label: 'All Articles', icon: Layers, count: 180 },
  { id: 'admission', label: 'B-School Admission', icon: GraduationCap, count: 42 },
  { id: 'specializations', label: 'MBA Specializations', icon: Code, count: 31 },
  { id: 'colleges', label: 'B-School Reviews', icon: Building, count: 45 },
  { id: 'exams', label: 'CAT & Entrance', icon: FileText, count: 26 },
  { id: 'career', label: 'Corporate Careers', icon: Briefcase, count: 38 },
  { id: 'campus', label: 'MBA Life', icon: Users, count: 24 },
]

const LEVEL_CONFIG: Record<string, { label: string; color: string; bg: string; ring: string }> = {
  beginner: { label: 'UG Base', color: '#10b981', bg: '#ecfdf5', ring: '#a7f3d0' },
  intermediate: { label: 'Aspirant', color: '#0ea5e9', bg: '#f0f9ff', ring: '#bae6fd' },
  advanced: { label: 'MBA Student', color: '#8b5cf6', bg: '#f5f3ff', ring: '#ddd6fe' },
  expert: { label: 'Business Leader', color: '#f59e0b', bg: '#fffbeb', ring: '#fde68a' },
}
...
const JOURNEY_LEVELS = [
  {
    ...
    description: 'Profile building, work-ex planning, and choosing the right MBA path.',
    articles: 32,
    icon: '📊',
  ...
  },
  {
    ...
    title: 'MBA Student',
    subtitle: 'The Build',
    description: 'Summer internships, case competitions, and specialization choice.',
    articles: 62,
    icon: '💼',
  ...
  },
  {
    ...
    subtitle: 'The Launch',
    description: 'Lateral placements, corporate growth, and entrepreneurial ventures.',
    articles: 44,
    icon: '🚀',
...
const TRENDING_TOPICS = [
  'CAT 2026', 'IIM Ahmedabad', 'MBA in Finance', 'GMAT Focus',
  'Consulting Roles', 'MBA Fees', 'Executive MBA', 'Placement ROI',
  'Product Management', 'MBA vs MS', 'Case Competitions',
]
...
const FREE_RESOURCES: ResourceCard[] = [
  {
    ...
    description: 'Calculate your chances for IIMs and top private B-schools based on your profile and mocks.',
  ...
  },
  {
    ...
    description: 'Download the 2026 CAT score vs percentile mapping based on latest session difficulty.',
  ...
  },
  {
    ...
    description: 'Discover if your profile fits Marketing, Finance, HR, or Operations best.',
    cta: 'Take Quiz',
    color: '#7c3aed',
    bg: '#f5f3ff',
    border: '#ddd6fe',
  },
  {
    ...
    description: 'Get our internal guide on handling stress interviews and abstract GD topics.',
  ...
  useEffect(() => {
    async function loadArticles() {
      try {
        ...
        console.error('[Supabase] Error loading MBA articles:', err)
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#f4f9fd', fontFamily: "'DM Sans', sans-serif", overflowX: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: '840px' }}>
            ...
            <h1 className="font-display hero-fade" style={{
              ...
              The MBA Blueprint.<br />
              <em style={{ color: '#0284c7' }}>From CAT Strategy to B-Schools.</em>
            </h1>
            ...
            <p className="hero-fade" style={{
              ...
              Mastering Management. India's most comprehensive resource for CAT/GMAT prep, B-school reviews, and corporate career paths.
            </p>
            ...
            <div className="hero-fade" style={{ position: 'relative', maxWidth: '600px', marginBottom: '40px' }}>
              ...
              <input
                ...
                placeholder="Search CAT strategy, IIM reviews, careers..."
                style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <h2 className="section-title font-display">
                The MBA Roadmap — Aspirant to Leader
              </h2>
            </div>
          </div>
        ...
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <h2 className="section-title font-display" style={{ marginBottom: '12px' }}>
              Free B-School <span style={{ color: '#0284c7' }}>Preparation Tools</span>
            </h2>
          </div>
      ...
      <section style={{ padding: '72px 0', background: '#ffffff' }}>
        <div className="container">
          ...
          <div style={{ textAlign: 'center', marginTop: '64px', marginBottom: '48px' }}>
            <h2 className="section-title font-display">Management Insights</h2>
          </div>
      ...
      <section style={{ padding: '72px 0', background: '#ffffff', borderTop: '1px solid #e6f2fc' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <h2 className="section-title font-display">Candidate Stories</h2>
          </div>
      ...
      <section style={{ padding: '72px 0', background: '#f0f7ff' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <h2 className="section-title font-display">MBA Specializations</h2>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
            {[
              { icon: '💰', title: 'Finance & Fintech', count: '18 articles', color: '#fee2e2', border: '#fca5a5', text: '#dc2626' },
              { icon: '📣', title: 'Marketing & Digital', count: '14 articles', color: '#f0f9ff', border: '#bae6fd', text: '#0369a1' },
              { icon: '📊', title: 'Business Analytics', count: '12 articles', color: '#ecfdf5', border: '#a7f3d0', text: '#059669' },
              { icon: '⚙️', title: 'Operations & SCM', count: '9 articles', color: '#fdf4ff', border: '#e879f9', text: '#a21caf' },
              { icon: '🏢', title: 'HR & Leadership', count: '11 articles', color: '#fffbeb', border: '#fde68a', text: '#d97706' },
              { icon: '🌍', title: 'Global MBA', count: '15 articles', color: '#f0f9ff', border: '#bae6fd', text: '#0369a1' },
            ].map((g, i) => (
              <div key={i} style={{
