...
import {
  ...
  Users, Clock, Eye, ArrowRight, Star, Search, Flame, Stethoscope, BookOpen, ClipboardList,
...
const CATEGORIES = [
  { id: 'all', label: 'All Articles', icon: Layers, count: 140 },
  { id: 'admission', label: 'Admission Guide', icon: GraduationCap, count: 32 },
  { id: 'clinical', label: 'Clinical Skills', icon: Stethoscope, count: 28 },
  { id: 'colleges', label: 'College Reviews', icon: Building, count: 35 },
  { id: 'exams', label: 'Entrance & NORCET', icon: FileText, count: 22 },
  { id: 'career', label: 'Nursing Careers', icon: Briefcase, count: 29 },
  { id: 'campus', label: 'Nursing Life', icon: Users, count: 18 },
]

const LEVEL_CONFIG: Record<string, { label: string; color: string; bg: string; ring: string }> = {
  beginner: { label: 'Aspiring Nurse', color: '#10b981', bg: '#ecfdf5', ring: '#a7f3d0' },
  intermediate: { label: 'Nursing Student', color: '#0ea5e9', bg: '#f0f9ff', ring: '#bae6fd' },
  advanced: { label: 'Professional', color: '#8b5cf6', bg: '#f5f3ff', ring: '#ddd6fe' },
  expert: { label: 'Advanced Practice', color: '#f59e0b', bg: '#fffbeb', ring: '#fde68a' },
}
...
const JOURNEY_LEVELS = [
  {
    ...
    subtitle: 'The Entry',
    description: 'Understanding B.Sc Nursing, NEET vs AIIMS Nursing, and college choice.',
    articles: 28,
    icon: '🏥',
  ...
  },
  {
    ...
    description: 'Clinical rotations, anatomy mastery, lab work, and semester exams.',
    articles: 42,
    icon: '🩺',
  ...
  },
  {
    ...
    description: 'Internships, NORCET preparation, and clinical expertise building.',
    articles: 51,
    icon: '🩹',
  ...
  },
  {
    ...
    subtitle: 'The Lead',
    description: 'M.Sc Nursing, ICU specialization, teaching, and international opportunities.',
    articles: 35,
    icon: '📈',
...
const TRENDING_TOPICS = [
  'NORCET 2026', 'AIIMS Nursing', 'Staff Nurse Salary', 'ICU Nursing',
  'Nursing vs MBBS', 'Top Nursing Colleges', 'ANM/GNM vs BSc',
  'Clinical Skills', 'NCLEX Exam', 'Nursing Internships',
]

const STATS = [
  { value: '140+', label: 'Clinical Guides', icon: FileText },
  { value: '1.2L+', label: 'Monthly Nursing Readers', icon: Users },
...
const FREE_RESOURCES: ResourceCard[] = [
  ...
  },
  {
    ...
    description: 'Complete list of essential procedures and clinical competencies for first-year nursing students.',
    cta: 'Download PDF',
    color: '#059669',
    bg: '#ecfdf5',
    border: '#a7f3d0',
...
const TESTIMONIALS = [
  {
    quote: "The NORCET preparation articles helped me secure a seat in AIIMS Rishikesh. The topic-wise breakdown was incredible.",
    name: "Sneha Reddy",
    detail: "AIIMS Rishikesh, Staff Nurse '26",
    avatar: "SR",
  },
  {
    quote: "As a student, the clinical skill guides were my best friend during the first year of my rotations.",
    name: "Rahul Verma",
    detail: "CMC Vellore, B.Sc Nursing '27",
    avatar: "RV",
  },
  {
    quote: "Clarified all my doubts regarding the difference between private and government nursing colleges. Very transparent.",
    name: "Meera Das",
    detail: "SNDT Mumbai, '28",
    avatar: "MD",
  },
]
...
const ResourceCardComponent = ({ resource }: { resource: ResourceCard }) => (
  ...
  >
    <div style={{ marginBottom: '16px', color: resource.color }}>
...
export default function NursingBlogPage() {
  ...
  useEffect(() => {
    async function loadArticles() {
      try {
        ...
        console.error('[Supabase] Error loading Nursing articles:', err)
  ...
  const filteredArticles = articles.filter(a => {
    ...
    const catMatch = activeCategory === 'all' || 
      a.category.toLowerCase().includes(activeCategoryLabel.toLowerCase().replace(' admission', '').replace('s', '').trim()) ||
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#f4f9fd', fontFamily: "'DM Sans', sans-serif", overflowX: 'hidden' }}>
          ...
          <div style={{ maxWidth: '840px' }}>
            <div className="hero-fade" style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '28px' }}>
              ...
              <span style={{
                ...
                Nursing Knowledge Hub · 140+ Guides
              </span>
            </div>
            ...
            <h1 className="font-display hero-fade" style={{
              ...
              Compassion Meets Excellence.<br />
              <em style={{ color: '#0284c7' }}>Your Nursing Career Starts Here.</em>
            </h1>
            ...
            <p className="hero-fade" style={{
              ...
              Mastering Clinical Care. India's most comprehensive resource for AIIMS Nursing prep, clinical skills, and professional career paths.
            </p>
            ...
            <div className="hero-fade" style={{ position: 'relative', maxWidth: '600px', marginBottom: '40px' }}>
              ...
              <input
                ...
                placeholder="Search AIIMS Nursing, clinical skills, NORCET..."
                style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <h2 className="section-title font-display">
                The Nursing Roadmap — Student to Specialist
              </h2>
            </div>
          </div>
        ...
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <h2 className="section-title font-display" style={{ marginBottom: '12px' }}>
              Free Nursing <span style={{ color: '#0284c7' }}>Preparation Tools</span>
            </h2>
          </div>
      ...
      <section style={{ padding: '72px 0', background: '#ffffff' }}>
        <div className="container">
                ...
                <article key={a.id} className="group" style={{
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', gap: '6px', marginBottom: '10px' }}>
                      <TagBadge tag={a.tag || 'Strategy'} hot={a.isHot} />
          ...
          <div style={{ textAlign: 'center', marginTop: '64px', marginBottom: '48px' }}>
            <h2 className="section-title font-display">Nursing Insights</h2>
          </div>
      ...
      <section style={{ padding: '72px 0', background: '#f0f7ff' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <h2 className="section-title font-display">Nursing Specializations</h2>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
            {[
              { icon: Activity, title: 'Critical Care (ICU)', count: '14 articles', color: '#fee2e2', border: '#fca5a5', text: '#dc2626' },
              { icon: Heart, title: 'Pediatric Nursing', count: '11 articles', color: '#f0f9ff', border: '#bae6fd', text: '#0369a1' },
              { icon: Zap, title: 'OT & Emergency', count: '9 articles', color: '#ecfdf5', border: '#a7f3d0', text: '#059669' },
              { icon: MessageCircle, title: 'Psychiatric Care', count: '7 articles', color: '#fdf4ff', border: '#e879f9', text: '#a21caf' },
              { icon: GraduationCap, title: 'M.Sc & Education', count: '12 articles', color: '#fffbeb', border: '#fde68a', text: '#d97706' },
              { icon: Globe, title: 'Global Opportunities', count: '15 articles', color: '#f0f9ff', border: '#bae6fd', text: '#0369a1' },
            ].map((g, i) => (
              <div key={i} style={{
                ...
                <div style={{ marginBottom: '12px', color: g.text }}>
                  <g.icon size={28} />
                </div>
