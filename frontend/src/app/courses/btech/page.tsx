  ...
  useEffect(() => {
    async function loadArticles() {
      try {
        ...
        console.error('[Supabase] Error loading B.Tech articles:', err)
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#f4f9fd', fontFamily: "'DM Sans', sans-serif", overflowX: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ maxWidth: '840px' }}>
            ...
            <p className="hero-fade" style={{
              ...
              Engineering your future. India's most comprehensive resource for JEE prep, branch selection, and tech career roadmaps.
            </p>
            ...
            <div className="hero-fade" style={{ position: 'relative', maxWidth: '600px', marginBottom: '40px' }}>
              ...
              <input
                ...
                placeholder="Search JEE strategy, CSE vs ECE, IIT reviews..."
                style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <h2 className="section-title font-display">
                The B.Tech Journey — Student to Professional
              </h2>
            </div>
          </div>
        ...
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <h2 className="section-title font-display" style={{ marginBottom: '12px' }}>
              Free B.Tech <span style={{ color: '#0284c7' }}>Preparation Tools</span>
            </h2>
          </div>
      ...
      <section style={{ padding: '72px 0', background: '#ffffff' }}>
        <div className="container">
          ...
          <div style={{ textAlign: 'center', marginTop: '64px', marginBottom: '48px' }}>
            <h2 className="section-title font-display">B.Tech Insights</h2>
          </div>
      ...
      <section style={{ padding: '72px 0', background: '#f0f7ff' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <h2 className="section-title font-display">Branch Deep Dives</h2>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
            {[
              { icon: '💻', title: 'CSE & IT', count: '48 articles', color: '#fee2e2', border: '#fca5a5', text: '#dc2626' },
              { icon: '🛰️', title: 'ECE & Robotics', count: '36 articles', color: '#f0f9ff', border: '#bae6fd', text: '#0369a1' },
              { icon: '🏗️', title: 'Civil & Infra', count: '24 articles', color: '#ecfdf5', border: '#a7f3d0', text: '#059669' },
              { icon: '⚙️', title: 'Mechanical & Auto', count: '31 articles', color: '#fdf4ff', border: '#e879f9', text: '#a21caf' },
              { icon: '⚡', title: 'Electrical & EV', count: '27 articles', color: '#fffbeb', border: '#fde68a', text: '#d97706' },
              { icon: '🧪', title: 'Biotech & Chem', count: '19 articles', color: '#f0f9ff', border: '#bae6fd', text: '#0369a1' },
            ].map((g, i) => (
              <div key={i} style={{
